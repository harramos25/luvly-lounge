                ...
                {!isSkipped ? (
                    ...
                    <div className="p-6 border-t border-red-900/30 flex flex-col gap-4 animate-in slide-in-from-bottom-10 pb-safe">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button onClick={() => router.push('/dashboard/match')} className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-[#FF6B91] to-[#A67CFF] text-white font-bold text-sm rounded-xl hover:scale-[1.02] transition-transform shadow-lg shadow-purple-500/20">
