...
import { Camera, Save, Calendar, ChevronLeft } from "lucide-react";
...
export default function EditProfilePage() {
    ...
    const handleSave = async () => {
        ...
        setLoading(false);
        // Direct real-time redirect
        router.push("/dashboard/profile");
        router.refresh(); // Ensure data is stale
    };
        ...
        <div className="min-h-screen bg-black text-white p-4 md:p-8 flex justify-center">
            <div className="max-w-xl w-full space-y-8">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/profile" className="p-2 hover:bg-zinc-800 rounded-full transition-colors">
                        <ChevronLeft size={24} />
                    </Link>
                ...
                <button onClick={handleSave} disabled={loading} className="bg-white text-black font-bold py-3 px-6 rounded-xl flex items-center gap-2 hover:bg-zinc-200 transition-colors w-full justify-center">
