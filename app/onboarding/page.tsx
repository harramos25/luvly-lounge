...
import { User, Heart, Sparkles, ArrowRight, Camera, Check, Plus, X, AlertTriangle } from "lucide-react";
...
const handleBirthdayNext = async () => {
    ...
    if (age < 18) {
        // UNDERAGE DETECTED
        if (confirm("You must be 18+ to use Luvly Lounge. Your account will be deleted.")) {
            await deleteAccount();
            router.replace("/login"); // Or intro
